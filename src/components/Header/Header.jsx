  ...
  return (
    <div className="header">
      ...
      <div style={{display: "flex", flexDirection: "row", alignItems:'center', color: "white"}}>
        <div style={{cursor:'pointer', margin:'0 10px 0 10px'}} onClick={()=> changeLanguage("eng")} href="kdn">Eng</div>
        <div style={{cursor:'pointer', margin:'0 10px 0 10px'}} onClick={()=> changeLanguage("ru")} href="kdn">Ru</div>
        <div style={{cursor:'pointer', margin:'0 10px 0 10px'}} onClick={()=> changeLanguage("kg")} href="kdn">Kg</div>
      </div>
